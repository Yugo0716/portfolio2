...
export const nodesData: NodeType[] = [
  ...
  { id: 4, label: "散歩/サイクリング", description: "知らない道を通ったり、景色を眺めたりするととてもリラックスできるので暇な時によくします", group: "desc"},
  ...
  { id: 7, label: "野球", description: "小学生～高校生まで軟式野球に取り組んでおりました。私はどちらかというとインドアな人間ですが、野球は好きで友達とキャッチボールをしたりバッティングセンターに行ったりします。" , group: "desc"},
  ...
  { id: 9, label: "アニメ" , description: "アニメに影響を受けて新しいことをやってみることが多くありました。", group: "desc"},
  ...
  {id: 19, label: "服", description:"カジュアル・モード系の服が多いです。できれば自分に合う服をもっと見つけたい...", group: "desc"}
];
...
export const edgesData: EdgeType[] = [
  ...
  { from: 1, to: 5 , label:"音にエフェクトをかける・リズム感", font: {size: 0}},
  ...
  { from: 1, to: 12 , label:"マルチプレイ", font: {size: 0}},
  ...
  { from: 5, to: 19 , label:"カッコよく見せる", font: {size: 0}},
  ...
  { from: 10, to: 12 , label:"コード分担・教え合い", font: {size: 0}},
